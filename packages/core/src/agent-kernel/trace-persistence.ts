  ...
  startSpan(
    ...
    const endSpan = (summary: string, metrics: SpanMetrics = {}, error?: string): Span => {
      ...
      span.metadata = {
        ...
        ...(metrics.summaryGenerationMs !== undefined ? { summaryGenerationMs: metrics.summaryGenerationMs } : {}),
        ...(metrics.summaryProcessingMs !== undefined ? { summaryProcessingMs: metrics.summaryProcessingMs } : {}),
        ...(metrics.historyProcessingMs !== undefined ? { historyProcessingMs: metrics.historyProcessingMs } : {}),
        ...(metrics.memorySearchMs !== undefined ? { memorySearchMs: metrics.memorySearchMs } : {}),
        ...(metrics.sourceCompressionMs !== undefined ? { sourceCompressionMs: metrics.sourceCompressionMs } : {}),
        ...(metrics.tokenBudgetMs !== undefined ? { tokenBudgetMs: metrics.tokenBudgetMs } : {}),
        ...(metrics.contextAssemblyMs !== undefined ? { contextAssemblyMs: metrics.contextAssemblyMs } : {}),
        ...(metrics.intentRouteMs !== undefined ? { intentRouteMs: metrics.intentRouteMs } : {}),
        ...(metrics.layer0FormMatchMs !== undefined ? { layer0FormMatchMs: metrics.layer0FormMatchMs } : {}),
        ...(metrics.layer1QueryEmbedMs !== undefined ? { layer1QueryEmbedMs: metrics.layer1QueryEmbedMs } : {}),
        ...(metrics.layer1SkillEmbedMs !== undefined ? { layer1SkillEmbedMs: metrics.layer1SkillEmbedMs } : {}),
        ...(metrics.layer2LlmMs !== undefined ? { layer2LlmMs: metrics.layer2LlmMs } : {}),
        ...(metrics.layer2TtftMs !== undefined ? { layer2TtftMs: metrics.layer2TtftMs } : {}),
