...
import type { ContextBuilderDeps, MemoryRetrievalMetrics } from "./types.js";
...
export class ContextAssemblyPipeline {
  ...
  async build(
    ...
    const memoryMetrics: MemoryRetrievalMetrics = {
      ...
      featureFlags: {
        multiHop: ContextAssemblyPipeline.FEATURE_MULTIHOP,
        queryExpansion: ContextAssemblyPipeline.FEATURE_QUERY_EXPANSION,
        mmrRerank: ContextAssemblyPipeline.FEATURE_MMR_RERANK,
      },
    };
    ...
    try {
      ...
      if (ContextAssemblyPipeline.DEBUG_TIMING) {
      ...
      if (
        ...
        try {
          ...
          if (
            ContextAssemblyPipeline.FEATURE_MULTIHOP &&
          ...
          if (
            ContextAssemblyPipeline.FEATURE_QUERY_EXPANSION &&
          ...
          if (
            ContextAssemblyPipeline.FEATURE_MMR_RERANK &&
